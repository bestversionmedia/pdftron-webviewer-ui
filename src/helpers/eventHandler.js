...
export default store => {
  ...
  const onAnnotationAdded = eventListeners.onAnnotationAdded(store);
  ...
  return {
    addEventHandlers: () => {
      ...
      core.getTool('AnnotationCreateTextHighlight').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight2').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight3').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight4').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextUnderline').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextSquiggly').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextStrikeout').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand2').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand3').on('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand4').on('annotationAdded', onAnnotationAdded);
    ...
    removeEventHandlers: () => {
      ...
      core.getTool('AnnotationCreateTextHighlight').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight2').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight3').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextHighlight4').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextUnderline').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextSquiggly').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateTextStrikeout').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand2').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand3').off('annotationAdded', onAnnotationAdded);
      core.getTool('AnnotationCreateFreeHand4').off('annotationAdded', onAnnotationAdded);
